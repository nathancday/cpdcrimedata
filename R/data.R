...
#' the original report, the extra 4 are: \code{lat}, \code{lon} \code{formatted_address}, and
#'   \code{loc_type}
"crime"

#' Geocoded addresses to the hundred-block
#'
#' On going list of addresses from the [CPD Crime Reports](http://opendata.charlottesville.org/datasets/crime-data), that have been successfully geocode via GoogleMaps
